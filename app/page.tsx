  ...
  return (
    <div className="min-h-screen">
      ...
      <section className="max-w-4xl mx-auto px-6 py-20 text-center">
        <h1 className="text-4xl md:text-5xl font-bold mb-4">MCPFlow - No-code MCP workflow builder for AI agent orchestration</h1>
        <p className="text-xl text-gray-600 mb-8 max-w-2xl mx-auto">Value Proposition: Visual workflow builder for Model Context Protocol orchestration, enabling non-technical teams to create AI agent workflows without coding, reducing implementation time from weeks to hours.
...
Promotion Type: automatic</p>
      ...
      <section className="max-w-4xl mx-auto px-6 py-20 text-center">
        ...
        <p className="text-gray-600 mb-6">Join thousands of small businesses who trust MCPFlow - No-code MCP workflow builder for AI agent orchestration.</p>
      ...
      <footer className="border-t py-8">
        <div className="max-w-4xl mx-auto px-6 flex justify-between text-sm text-gray-500">
          <p>© {new Date().getFullYear()} MCPFlow - No-code MCP workflow builder for AI agent orchestration. All rights reserved.</p>
