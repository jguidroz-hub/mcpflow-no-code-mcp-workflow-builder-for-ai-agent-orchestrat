...
const FROM = process.env.EMAIL_FROM || 'MCPFlow - No-code MCP workflow builder for AI agent orchestration <noreply@example.com>';
const APP_NAME = 'MCPFlow - No-code MCP workflow builder for AI agent orchestration';
